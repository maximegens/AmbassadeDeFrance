...
/**
 * An activity representing a list of LesAmbassades. This activity
 * has different presentations for handset and tablet-size devices. On
 * handsets, the activity presents a list of items, which when touched,
 * lead to a {@link AmbassadeDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p/>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link AmbassadeListFragment} and the item details
 * (if present) is a {@link AmbassadeDetailFragment}.
 * <p/>
...
public class AmbassadeListActivity extends FragmentActivity
    ...
    /**
     * Callback method from {@link AmbassadeListFragment.Callbacks}
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            detailIntent.putExtra(AmbassadeDetailFragment.ARG_ITEM_ID, id);
